...
<!-- Content Row -->
        <div class="card shadow">
            ...
            <div class="card-body">
                <form action="{{ route('epreuve.update', $epreuve->numEp) }}" method="POST">
                    @csrf
                    @method('put')
                    <div class="form-group">
                        <label for="nomEp">Nom_epreuve</label>
                        <input type="text" class="form-control" id="nomEp" placeholder="nom de l'epreuve" name="nomEp" value="{{ old('nomEp',$epreuve->nomEp)}}" />
                    </div>
                    <div class="form-group">
                        <label for="dateEp">Date_epreuve</label>
                        <input type="date" class="form-control" id="dateEp" placeholder="date Epreuve" name="dateEp" value="{{ old('dateEp',$epreuve->dateEp)}}" />
                    </div>
                    <div class="form-group">
                        <label for="heurDeb">Heure_de_debut</label>
                        <input type="time" class="form-control" id="heurDeb" placeholder="heure de Debut" name="heurDeb" value="{{ old('heurDeb',$epreuve->heurDeb)}}" />
                    </div>
                    <div class="form-group">
                        <label for="heurFin">Heure de fin </label>
                        <input type="time" class="form-control" id="heurFin" placeholder="heure de Fin" name="heurFin" value="{{ old('heurFin',$epreuve->heurFin)}}" />
                    </div>
                    <div class="form-group">
