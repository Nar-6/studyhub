        ...
        <div class="card shadow">
            <div class="card-header">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Modifier l'epreuve</h1>
                    <a href="<?php echo e(route('epreuve.index')); ?>" class="btn btn-primary btn-sm shadow-sm">Retour</a>
                </div>
            </div>
            <div class="card-body">
                <form action="<?php echo e(route('epreuve.update', $epreuve->numEp)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('put'); ?>
                    <div class="form-group">
                        <label for="nomEp">Nom_epreuve</label>
                        <input type="text" class="form-control" id="nomEp" placeholder="nom de l'epreuve" name="nomEp" value="<?php echo e(old('nomEp',$epreuve->nomEp)); ?>" />
                    </div>
                    <div class="form-group">
                        <label for="dateEp">Date_epreuve</label>
                        <input type="date" class="form-control" id="dateEp" placeholder="date Epreuve" name="dateEp" value="<?php echo e(old('dateEp',$epreuve->dateEp)); ?>" />
                    </div>
                    <div class="form-group">
                        <label for="heurDeb">Heure_de_debut</label>
                        <input type="time" class="form-control" id="heurDeb" placeholder="heure de Debut" name="heurDeb" value="<?php echo e(old('heurDeb',$epreuve->heurDeb)); ?>" />
                    </div>
                    <div class="form-group">
                        <label for="heurFin">Heure de fin </label>
                        <input type="time" class="form-control" id="heurFin" placeholder="heure de Fin" name="heurFin" value="<?php echo e(old('heurFin',$epreuve->heurFin)); ?>" />
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-primary btn-block">Modifier une epreuve</button>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\EliteBook 830 G8\Documents\document_sauvegarde\studyhub\resources\views/professeur/epreuves/edit.blade.php ENDPATH**/ ?>