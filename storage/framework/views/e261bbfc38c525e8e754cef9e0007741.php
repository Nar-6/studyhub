            ...
            <div class="card-body">
                <form action="<?php echo e(route('option.update', $option->id)); ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="option_text" placeholder="Option de reponse" name="option_text" value="<?php echo e(old('option_text', $option->option_text)); ?>" " />
                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\EliteBook 830 G8\Documents\document_sauvegarde\studyhub\resources\views/professeur/options/edit.blade.php ENDPATH**/ ?>